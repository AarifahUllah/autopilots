...
#Just for debugging purposes, feel free to delete if it clutters too much
...
def main():
    ...
    #Add ArUco detection
    #Run aruco detection for 5 seconds, this should also block this main for 5 seconds
    aruco_detection(5)
